...
# SPDX-FileCopyrightText: Adapted for MicroPython (RP2040) by [https://github.com/control-carro-embebidos], 2025
#
# SPDX-License-Identifier: MIT
"""
OV7670 MicroPython Driver (based on Adafruit CircuitPython OV7670)

This file adapts the original Adafruit CircuitPython OV7670 driver for use with
MicroPython boards such as the Raspberry Pi Pico. It reimplements hardware
interfaces (PWM, I2C, PIO) using the MicroPython `machine` and `rp2` modules.
